...
import { Input, Icon, Button, Select, Form } from "antd";
  ...
  return (
    <div className="register-container">
      ...
      <Form>
        ...
        >
          <div className={"form-item"}>
            <Input
              ...
              onChange={e =>
                onChangeRegistrationData("firstName", e.target.value)
              }
              allowClear={true}
        ...
        >
          <div className={"form-item"}>
            <Input
              ...
              onChange={e =>
                onChangeRegistrationData("lastName", e.target.value)
              }
              allowClear={true}
              style={{ marginTop: 20, width: 400 }}
            />
        ...
        <Form.Item
          validateStatus={checkValidationErrors("email") ? "error" : undefined}
        >
          <div className={"form-item"}>
            <Input
              placeholder={"Email"}
        ...
        <Form.Item
          validateStatus={
            checkValidationErrors("password") ? "error" : undefined
          }
        >
          <div className={"form-item"}>
            <Input.Password
              ...
              onChange={e =>
                onChangeRegistrationData("password", e.target.value)
              }
              allowClear={true}
              style={{ marginTop: 20, width: 400 }}
            />
        ...
        <Form.Item
          validateStatus={checkValidationErrors("phone") ? "error" : undefined}
        >
          <div className={"form-item"}>
            <Input
              placeholder={"Phone"}
